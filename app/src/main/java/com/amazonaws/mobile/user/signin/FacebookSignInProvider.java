...
import com.amazonaws.mobile.ns.NSFacebookLoginRequest;
...
public class FacebookSignInProvider implements SignInProvider {
    ...
    /** {@inheritDoc} */
    @Override
    public void initialize(final Activity signInActivity,
        ...
        LoginManager.getInstance().registerCallback(facebookCallbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onSuccess(LoginResult loginResult) {
                ...
                //NSProvider.getFacebookLoginHandler().onSuccess(FacebookSignInProvider.this);
            ...
            public void onCancel() {
                ...
                //NSProvider.getFacebookLoginHandler().onCancel();
            }
            ...
            public void onError(FacebookException exception) {
                ...
                //NSProvider.getFacebookLoginHandler().onFailure(exception);
            }
        });

        NSProvider.setFacebookLoginRequest(new NSFacebookLoginRequest() {
            @Override
            public void request(Activity activity) {

                LoginManager.getInstance().logInWithReadPermissions(activity != null ? activity : signInActivity,
